    ...
    var b = {
        init: function () {
            return this.each(function () {
                ...
                a(window).width();
                b.width("100%");
                var c, d, e = b.find("li.ttab a"), f = b.width(), g = b.find("li").first().outerWidth(), h = 0;
                c = a(e.filter('[href="' + location.hash + '"]')), 0 === c.length && (c = a(this).find("li.ttab a.active").first()), 0 === c.length && (c = a(this).find("li.ttab a").first()), c.addClass("active"), h = e.index(c), 0 > h && (h = 0), d = a(c[0].hash), b.append('<div class="indicator"></div>');
                ...
                b.is(":visible") && (i.css({right: f - (h + 1) * g}), i.css({left: h * g})), a(window).resize(function () {
                    ...
                    f = b.width(), g = b.find("li").first().outerWidth(), c.removeClass("active"), d.hide(), c = a(this), d = a(this.hash), e = b.find("li.ttab a"), c.addClass("active");
                    var k = h;
